...
<div id="mArticle">
    ...
    <div class="view_brand view_video">
        <div class="head_view">
            <h3 class="tit_view">춥지마 라이언!</h3>
            <em class="txt_category">Video</em>
        </div>
        <div class="box_vod box_fbvod">
            <div class="inner_vod">
                <iframe src="https://www.youtube.com/embed/Ex-05jnH-e8?rel=0&amp;showinfo=0" title="카카오프렌즈-춥지마 라이언! (Ryan's warm winter)" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <p class="desc_video">눈 내리는 2017년의 추운 어느날- <br class="rw_hide">갈기 없는 숫사자 라이언에게 맞는 따뜻한 옷을 찾았어요!</p>
        <!-- 연관 상품 -->
