...
<div id="mArticle">
    ...
    <div class="view_brand view_download">
        <div class="head_view">
            <h3 class="tit_view">2019년 1월의 배경화면</h3>
            <em class="txt_category">Wallpaper</em>
        </div>
        <!-- 이미지 브라우저 너비 -->
        <div class="img_fullfit img_fullfit1">
            <img src="https://t1.kakaocdn.net/friends/prod/brand/201901_type1_2880.jpg" class="thumb_g rw_show" alt="2019년 1월의 배경화면"><!-- PC : alt 값 넣어주세요 -->
        ...
        <ul class="list_download">
            <li>
                <a href="/download?url=https://t1.kakaocdn.net/friends/prod/brand/201901_type1_750.jpg" class="link_download" target="_blank" download>
                    <span class="ico_download"><span class="ico_newfriends_v1">2019년 1월의 배경화면 다운로드</span></span>
            ...
            <li>
                <a href="/download?url=https://t1.kakaocdn.net/friends/prod/brand/201901_type1_1440.jpg" class="link_download" target="_blank" download>
                    <span class="ico_download"><span class="ico_newfriends_v1">2019년 1월의 배경화면 다운로드</span></span>
            ...
            <li>
                <a href="/download?url=https://t1.kakaocdn.net/friends/prod/brand/201901_type1_1920.jpg" class="link_download link_pc" target="_blank" download>
                    <span class="ico_download"><span class="ico_newfriends_v1">2019년 1월의 배경화면 다운로드</span></span>
            ...
            <li>
                <a href="/download?url=https://t1.kakaocdn.net/friends/prod/brand/201901_type1_2880.jpg" class="link_download link_pc" target="_blank" download>
                    <span class="ico_download"><span class="ico_newfriends_v1">2019년 1월의 배경화면 다운로드</span></span>
                    <span class="ico_newfriends_v1 txt_cate cate_pc"></span>
        ...
        <!-- 이미지 브라우저 너비 -->
        <div class="img_fullfit img_fullfit1">
            <img src="https://t1.kakaocdn.net/friends/prod/brand/201901_type2_2880.jpg" class="thumb_g rw_show" alt="2019년 1월의 배경화면(달력)"><!-- PC : alt 값 넣어주세요 -->
            <img src="https://t1.kakaocdn.net/friends/kfo-common/mo/m640/brand/thumb_wallpaper_201901_type2.jpg" class="thumb_g rw_hide" alt="2019년 1월의 배경화면(달력)"><!-- Moblie : alt 값 넣어주세요 -->
        </div>
        <ul class="list_download">
            <li>
                <a href="/download?url=https://t1.kakaocdn.net/friends/prod/brand/201901_type2_750.jpg" class="link_download" target="_blank" download>
                    <span class="ico_download"><span class="ico_newfriends_v1">2019년 1월의 배경화면(달력) 다운로드</span></span>
                    <span class="ico_newfriends_v1 txt_cate cate_ios"></span>
                    <strong class="tit_download">Mobile (iOS)</strong>
                    <span class="screen_out">해상도</span>
                    <span class="txt_spec">750 x 1334</span>
            ...
            <li>
                <a href="/download?url=https://t1.kakaocdn.net/friends/prod/brand/201901_type2_1440.jpg" class="link_download" target="_blank" download>
                    <span class="ico_download"><span class="ico_newfriends_v1">2019년 1월의 배경화면(달력) 다운로드</span></span>
                    <span class="ico_newfriends_v1 txt_cate cate_android"></span>
                    <strong class="tit_download">Mobile (Android)</strong>
                    <span class="screen_out">해상도</span>
            ...
            <li>
                <a href="/download?url=https://t1.kakaocdn.net/friends/prod/brand/201901_type2_1920.jpg" class="link_download link_pc" target="_blank" download>
                    <span class="ico_download"><span class="ico_newfriends_v1">2019년 1월의 배경화면(달력) 다운로드</span></span>
                    <span class="ico_newfriends_v1 txt_cate cate_pc"></span>
                    <strong class="tit_download">PC (16:9)</strong>
                    <span class="screen_out">해상도</span>
            ...
            <li>
                <a href="/download?url=https://t1.kakaocdn.net/friends/prod/brand/201901_type2_2880.jpg" class="link_download link_pc" target="_blank" download>
                    <span class="ico_download"><span class="ico_newfriends_v1">2019년 1월의 배경화면(달력) 다운로드</span></span>
                    <span class="ico_newfriends_v1 txt_cate cate_pc"></span>
                    <strong class="tit_download">PC (16:10)</strong>
                    <span class="screen_out">해상도</span>
