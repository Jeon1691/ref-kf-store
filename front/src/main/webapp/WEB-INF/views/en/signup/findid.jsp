	...
	<span class="thumb_g thumb_emoticon">
		...
		<div class="menu_tab menu_tab_type2">
			<ul class="tab_nav">
				...
				<li><a href="/en/usr/findpw" class="link_tab">Forgot your password</a></li>
			</ul>
		</div>
		<div class="info_find">
			<form>
				<fieldset>
					...
					<div class="group_find">
						<dl class="list_inp">
							<dt>
								<label for="memberName" class="lab_tf">Name<span class="screen_out"> input necessary</span></label><!-- 텍스트 입력시 screen_out 클래스 추가 -->
							</dt>
							<dd>
								<input type="text" id="memberName" name="memberName" class="tf_g" onkeyup="javascript:toggleLabel(this, 'screen_out');">
								<span class="txt_error" style="display:none">Please enter at least two letters for name.</span>
							</dd>
						</dl>
						<dl class="list_inp list_ph">
							<dt>
								<label for="receiver" class="lab_tf">Cellphone number<span class="screen_out"> input necessary</span></label><!-- 텍스트 입력시 screen_out 클래스 추가 -->
							</dt>
							<dd>
								<input type="text" id="receiver" name="receiver" class="tf_g" onkeyup="javascript:toggleLabel(this, 'screen_out');">
								<div class="sort_btn">
									<button onclick="javascript:isResendable(); return false;" class="btn_g tfPhoneAuth">Verify</button>
								</div>
					...
					<span class="txt_g">You can find your ID (email) through your registered name and cellphone number.</span>
				</span>
					<button onclick="javascript:complete(); return false;" class="btn_signup">OK</button>
				</fieldset>
			</form>
		</div>
	</div>
...
<script type="text/javascript">
    ...
    function complete(){
        ...
        if(email != null && email.length > 0) {
            window.location.href = "/en/usr/findidComplete";
        } else {
