...
<div id="mArticle">
	<div class="cont_welcome">
		<%--<dl class="info_membership">--%>
			...
			<%--</dd>--%>
		<%--</dl>--%>
		<strong class="screen_out">Membership benefits</strong>
		<ul class="list_welcome">
			<%--<li>회원가입 시 <em class="emph_g">3,000포인트</em>를 지급해드려요.</li>--%>
			<li>Certain amount of points will be given when you
				make a purchase.
				</li>
			<li>You will receive notifications for events and
				discount coupons.
				</li>
			<li>We will share with you information on our new
				products.</li>
