		...
		<form id="frm">
			...
			<fieldset>
				...
				<div class="group_join">
					...
					<dl class="list_inp ">
						<dt><label class="lab_tf" for="tfPw">New password<span class="screen_out"> input necessary</span></label></dt>
						...
						<dd class="info_password">
							...
							<span class="txt_error">Please enter 6-15 digits including alphabet letters and numbers for your password.</span>
						</dd>
					</dl>
					<dl class="list_inp">
						<dt><label class="lab_tf" for="tfPwconfirm">Re-enter new password<span class="screen_out"> input necessary</span></label></dt>
						<!-- 비밀번호 입력시 screen_out 클래스 추가 -->
						<dd class="info_password">
							...
							<span class="txt_error">The password does not match. Please try again.</span>
						</dd>
					</dl>
					<dl class="list_inp">
						...
						<div class="privacy_table">
							<table class="tbl_privacy">
								...
								<tr>
									...
									<th scope="col" colspan="2">Optional field</th>
								</tr>
								</thead>
								<tbody>
								<tr>
...
<script>
    ...
    function isExistEmail(){
        ...
        $.ajax({
            ...
            async:false,
            error: function () {
                alert('An error has occurred during the process.');
                result = true;
            },
            success: function (data) {
                //중복체크 후 결과값을 통해 에러문구 노출
