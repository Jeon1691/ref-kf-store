...
<spring:eval expression="@environment['pgIniPay50.P_NEXT_URL_ADD_EN']" var="P_NEXT_URL_ADD"/>
<spring:eval expression="@environment['pgIniPay50.P_NOTI_URL_ADD_EN']" var="P_NOTI_URL_ADD"/>
<spring:eval expression="@environment['pgIniPay50.P_RETURN_URL_ADD_EN']" var="P_RETURN_URL_ADD"/>
