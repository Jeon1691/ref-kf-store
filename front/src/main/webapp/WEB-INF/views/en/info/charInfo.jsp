...
<div id="mArticle">
    ...
    <!-- ko -->
    <div class="wrap_charinfo" lang="ko">
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/23"><span class="ico_newfriends_v1 ico_arrow"></span>제품보기</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/6"><span class="ico_newfriends_v1 ico_arrow"></span>제품보기</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/5"><span class="ico_newfriends_v1 ico_arrow"></span>제품보기</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/7"><span class="ico_newfriends_v1 ico_arrow"></span>제품보기</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/9"><span class="ico_newfriends_v1 ico_arrow"></span>제품보기</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/10"><span class="ico_newfriends_v1 ico_arrow"></span>제품보기</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- en -->
    <div class="wrap_charinfo lang_on" lang="en">
        <div class="section_charinfo">
            <div class="inner_character">
                <div class="area_img">
                    <span class="img_charInfo ico_ryan"></span>
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/23"><span class="ico_newfriends_v1 ico_arrow"></span>See Products</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/6"><span class="ico_newfriends_v1 ico_arrow"></span>See Products</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/5"><span class="ico_newfriends_v1 ico_arrow"></span>See Products</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/7"><span class="ico_newfriends_v1 ico_arrow"></span>See Products</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/9"><span class="ico_newfriends_v1 ico_arrow"></span>See Products</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/10"><span class="ico_newfriends_v1 ico_arrow"></span>See Products</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/23"><span class="ico_newfriends_v1 ico_arrow"></span>商品を見る</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/6"><span class="ico_newfriends_v1 ico_arrow"></span>商品を見る</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/5"><span class="ico_newfriends_v1 ico_arrow"></span>商品を見る</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/7"><span class="ico_newfriends_v1 ico_arrow"></span>商品を見る</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/9"><span class="ico_newfriends_v1 ico_arrow"></span>商品を見る</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/10"><span class="ico_newfriends_v1 ico_arrow"></span>商品を見る</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/23"><span class="ico_newfriends_v1 ico_arrow"></span>查看商品细节</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/6"><span class="ico_newfriends_v1 ico_arrow"></span>查看商品细节</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/5"><span class="ico_newfriends_v1 ico_arrow"></span>查看商品细节</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/7"><span class="ico_newfriends_v1 ico_arrow"></span>查看商品细节</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/9"><span class="ico_newfriends_v1 ico_arrow"></span>查看商品细节</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/10"><span class="ico_newfriends_v1 ico_arrow"></span>查看商品细节</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/23"><span class="ico_newfriends_v1 ico_arrow"></span>查看商品細節</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/6"><span class="ico_newfriends_v1 ico_arrow"></span>查看商品細節</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/5"><span class="ico_newfriends_v1 ico_arrow"></span>查看商品細節</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/7"><span class="ico_newfriends_v1 ico_arrow"></span>查看商品細節</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/9"><span class="ico_newfriends_v1 ico_arrow"></span>查看商品細節</a>
                </div>
            </div>
        </div>
        ...
        <div class="section_charinfo">
            <div class="inner_character">
                ...
                <div class="area_cont">
                    ...
                    <a class="link_view" href="${reqPath}/en/products/groups/characters/10"><span class="ico_newfriends_v1 ico_arrow"></span>查看商品細節</a>
                </div>
            </div>
        </div>
    </div>
