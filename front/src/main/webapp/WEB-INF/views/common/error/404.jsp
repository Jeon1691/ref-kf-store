...
<div id="kakaoWrap" class="wrap_error">
	...
	<hr class="hide">
	<div id="kakaoContent">
		<p class="desc_error desc_type3">
			<em class="emph_404error">404 - Not Found</em>
			<span class="txt_error"><spring:message code="notFound.error.message.first"/></span>
			<span class="txt_error"><spring:message code="notFound.error.message.second"/></span>
			<span class="txt_error"><spring:message code="notFound.error.message.third"/></span>
		</p>
		<div class="wrap_btn">
