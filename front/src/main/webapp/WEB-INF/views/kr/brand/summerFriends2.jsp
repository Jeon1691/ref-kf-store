...
<div id="mArticle">
    ...
    <div class="view_brand view_video">
        <div class="head_view">
            <h3 class="tit_view">프렌즈의 즐거운 여름 나기! ver. 서핑보드</h3>
            <em class="txt_category">Video</em>
        </div>
        <div class="box_vod box_fbvod">
            <div class="inner_vod">
                <iframe src="https://www.youtube.com/embed/vSwithvIIyk?rel=0&amp;showinfo=0" title="프렌즈의 즐거운 여름 나기 2" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <p class="desc_video">
            시원한 파도와 하나 되는 방법은? 카카오프렌즈 스토어에서 지금 바로 만나보세요!
        </p>
        <!-- 연관 상품 -->
