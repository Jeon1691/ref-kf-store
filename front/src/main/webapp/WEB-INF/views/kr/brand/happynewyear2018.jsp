...
<div id="mArticle">
    ...
    <div class="view_brand view_video">
        <div class="head_view">
            <h3 class="tit_view">카카오프렌즈가 전하는 복 받으세요</h3>
            <em class="txt_category">Video</em>
        </div>
        <div class="box_vod box_fbvod">
            <div class="inner_vod">
                <iframe src="https://www.youtube.com/embed/ZUFGsZ-jCys?rel=0&amp;showinfo=0" title="카카오프렌즈가 전하는 복 받으세요 (Happy new year! 2018!)" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <p class="desc_video">새해 복 많이 받으세요! 카카오프렌즈가 여러분에게 새해복을 마구마구 전해드릴게요-</p>
        <!-- 연관 상품 -->
