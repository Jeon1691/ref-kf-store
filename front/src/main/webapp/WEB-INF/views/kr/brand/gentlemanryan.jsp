...
<div id="mArticle">
    ...
    <div class="view_brand view_video">
        <div class="head_view">
            <h3 class="tit_view">젠틀맨 라이언의 하루</h3>
            <em class="txt_category">Video</em>
        </div>
        <div class="box_vod box_fbvod">
            <div class="inner_vod">
                <iframe src="https://www.youtube.com/embed/mrZE2aUoWRo?rel=0&amp;showinfo=0" title="젠틀맨 라이언의 하루 (Gentleman Ryan)" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <p class="desc_video">
            클래식한 테일러샵의 주인이 된 젠틀맨라이언-
        </p>
        <!-- 연관 상품 -->
