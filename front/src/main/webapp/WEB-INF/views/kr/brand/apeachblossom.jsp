...
<div id="mArticle">
    ...
    <div class="view_brand view_video">
        <div class="head_view">
            <h3 class="tit_view">어피치 뷰티팁 공개!</h3>
            <em class="txt_category">Video</em>
        </div>
        <div class="box_vod box_fbvod">
            <div class="inner_vod">
                <iframe src="https://www.youtube.com/embed/9GswWdzcYbI?rel=0&amp;showinfo=0" title="어피치 뷰티팁 공개! (Apeach's Beauty Tips)" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <p class="desc_video">‘어피치 블라썸’으로 사랑스러움 뿜뿜-</p>
        <!-- 연관 상품 -->
