...
<div id="mArticle">
    ...
    <div class="view_brand view_download">
        ...
        <div class="img_fullfit img_fullfit1">
            <img src="https://t1.kakaocdn.net/friends/prod/brand/201811_type1_2880.jpg" class="thumb_g rw_show" alt="2018년 10월의 배경화면"><!-- PC : alt 값 넣어주세요 -->
            <img src="https://t1.kakaocdn.net/friends/kfo-common/mo/m640/brand/thumb_wallpaper_201811_type1.jpg" class="thumb_g rw_hide" alt="2018년 10월의 배경화면"><!-- Moblie : alt 값 넣어주세요 -->
        </div>
        ...
        <!-- 이미지 브라우저 너비 -->
        <div class="img_fullfit img_fullfit1">
            <img src="https://t1.kakaocdn.net/friends/prod/brand/201811_type2_2880.jpg" class="thumb_g rw_show" alt="2018년 10월의 배경화면(달력)"><!-- PC : alt 값 넣어주세요 -->
            <img src="https://t1.kakaocdn.net/friends/kfo-common/mo/m640/brand/thumb_wallpaper_201811_type2.jpg" class="thumb_g rw_hide" alt="2018년 10월의 배경화면(달력)"><!-- Moblie : alt 값 넣어주세요 -->
        </div>
        <ul class="list_download">
            <li>
