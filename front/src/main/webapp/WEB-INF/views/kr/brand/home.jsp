...
<div id="mArticle">
	...
	<div class="brand_list">
		<ul class="list_brand">
			<!-- video type -->
			<li>
				<a href="/kr/brand/hello2019" class="link_brand">
			...
			<!-- download type -->
			<li>
				<a href="/kr/brand/wallpaper201812" class="link_brand">
			...
			<!-- download type -->
			<li>
				<a href="/kr/brand/wallpaper201808" class="link_brand">
			...
			<!-- download type -->
			<li>
				<a href="/kr/brand/wallpaper201806" class="link_brand">
			...
			<!-- video type -->
			<li>
				<a href="/kr/brand/flyingryan" class="link_brand">
			...
			<!-- video type -->
			<li>
				<a href="/kr/brand/gentlemanryan" class="link_brand">
			...
			<!-- sns type -->
			<li class="item_type3">
				<a href="/kr/brand/sweetapeach" class="link_brand">
			...
			<!-- sns type -->
			<li class="item_type3">
				<a href="/kr/brand/callaway" class="link_brand">
			...
			<!-- sns type -->
			<li class="item_type3">
				<a href="/kr/brand/thefaceshop" class="link_brand">
			...
			<!-- sns type -->
			<li class="item_type3">
				<a href="/kr/brand/kiehls" class="link_brand">
