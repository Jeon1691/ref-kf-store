...
<div id="mArticle">
    ...
    <div class="view_brand view_video">
        <div class="head_view">
            <h3 class="tit_view">댄싱머신 어피치의 트월킹 실력</h3>
            <em class="txt_category">Video</em>
        </div>
        <div class="box_vod box_fbvod">
            <div class="inner_vod">
                <iframe src="https://www.youtube.com/embed/hPmS4C08-zA?rel=0&amp;showinfo=0" title="댄싱머신 어피치의 트월킹 실력 (Shake it!)" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <p class="desc_video">
            어디서 좀 놀아보셨군요?
            <em class="emph_info">#프렌즈다이어리 09 #SHAKE IT</em>
        </p>
        <!-- 연관 상품 -->
