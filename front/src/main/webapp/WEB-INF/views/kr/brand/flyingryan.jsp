...
<div id="mArticle">
    ...
    <div class="view_brand view_video">
        <div class="head_view">
            <h3 class="tit_view">하늘을 나는 플라잉 라이언!</h3>
            <em class="txt_category">Video</em>
        </div>
        <div class="box_vod box_fbvod">
            <div class="inner_vod">
                <iframe src="https://www.youtube.com/embed/x6oxMX2OGCU?rel=0&amp;showinfo=0" title="하늘을 나는 플라잉 라이언! (Flying Ryan)" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <p class="desc_video">
            둥둥섬을 떠나 플라잉라이언 이 하늘을 날아요- 빨간 비행기를 탄 심쿵 라이언의 다양한 테마 상품을 만나보세요!
        </p>
        <!-- 연관 상품 -->
