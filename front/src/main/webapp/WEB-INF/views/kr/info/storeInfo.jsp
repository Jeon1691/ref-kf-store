...
<div id="mArticle">
    ...
    <div class="wrap_tab">
        <ul class="tab_lang">
            <li class="item_tab item_kr lang_on"><a href="#none" class="link_tab" lang="ko">한국어</a></li>
            ...
            <li class="item_tab item_hant"><a href="#none" class="link_tab" lang="zh-Hant">Test</a></li>
        </ul>
    </div>
    <!-- // tab -->

    <!-- ko -->
    <div class="wrap_storeinfo lang_on" lang="ko">
                ...
                <div class="section_store" data-area="seoul"><!-- 007 -->
                    ...
                    <div class="area_cont">
                        ...
                        <dl class="store_info">
                            ...
                            <dd>02-2231-3552</dd>
                            <dt><span class="ico_newfriends_v1 ico_time">영업시간 :</span></dt>
                            <dd>매일 10:30 - 22:00 <br>(매월 셋째주 월요일 휴무)</dd>
                            <dt><span class="ico_newfriends_v1 ico_address">주소 :</span></dt>
    ...
    <!-- en -->
    <div class="wrap_storeinfo" lang="en">
