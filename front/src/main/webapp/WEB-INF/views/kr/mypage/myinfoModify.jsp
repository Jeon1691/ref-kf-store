...
<div id="mArticle">
	...
	<div class="privacy_edit">
		<form id="frm">
			...
			<input type="hidden" id="phoneAuth" name="phoneAuth" value="true"/>
				...
				<div class="group_join">
					<dl class="list_inp">
						...
						<dd>
							...
							<span class="txt_error mailError1">잘못된 이메일 형식입니다. 확인 후 다시 입력해 주세요.</span>
							<span class="txt_error mailError2">이미 사용중인 이메일입니다. 다른 이메일을 입력해 주세요.</span>
						</dd>
					</dl>
					<dl class="list_inp ">
						<dt><label class="lab_tf" for="tfPw">비밀번호 (영문과 숫자 조합 6~15자 이내)</label></dt>
						<!-- 비밀번호 입력시 screen_out 클래스 추가 -->
						<dd class="info_password">
							<input type="password" class="tf_g" id="tfPw" onkeyup="toggleLabel(this, 'screen_out');">
							<span class="ico_newfriends_v1 ico_lock"></span>
							<span class="txt_error">비밀번호를 영문 / 숫자 조합 6~15자 이내로 입력해 주세요.</span>
						</dd>
					</dl>
					<dl class="list_inp">
						<dt><label class="lab_tf" for="tfPwconfirm">비밀번호 확인</label></dt>
						<!-- 비밀번호 입력시 screen_out 클래스 추가 -->
						<dd class="info_password">
							<input type="password" class="tf_g" id="tfPwconfirm" onkeyup="toggleLabel(this, 'screen_out');">
							<span class="ico_newfriends_v1 ico_lockchk"></span>
							<span class="txt_error">비밀번호가 다릅니다. 다시 확인해주세요.</span>
						</dd>
					</dl>
					<dl class="list_inp">
					...
					<dl class="list_inp list_phone">
						...
						<dd>
							...
							<span class="txt_error phoneError1">휴대폰 번호를 정확히 입력해 주세요.</span>
							<span class="txt_error phoneError2">이미 가입된 휴대폰번호 입니다.</span>
							<span class="txt_error phoneError3">휴대폰번호를 인증해 주세요.</span>
						</dd>
					</dl>
					...
					<dl class="list_inp list_phone" style="display: none;">
						...
						<dd>
							...
							<span class="txt_error authTimeExpire">인증번호 유효시간이 초과되었습니다.</span>
						</dd>
					</dl>
					...
					<div class="desc_privacy">
						...
						<div class="privacy_table">
							<table class="tbl_privacy">
								...
								<tr>
									<th scope="row">목적</th>
									<td colspan="2">맞춤정보제공, 마케팅, 이벤트 활용</td>
								</tr>
								<tr>
									<th scope="row">항목</th>
								...
								<tr class="lst">
									...
									<td>동의 철회 시 <br class="rw_hide">즉시 활용중지</td>
									<td>회원탈퇴 시 <br class="rw_hide"> 지체없이 5일이내 삭제</td>
								</tr>
								</tbody>
							</table>
						</div>
...
<script>
    $(function() {
        ...
        if(sessionStorage.getItem("isValidPassword")) {
            sessionStorage.removeItem("isValidPassword");
		} else {
            location.replace("/mypage/myinfo");
		}
