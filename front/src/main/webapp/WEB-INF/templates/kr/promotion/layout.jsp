...
<head>
    ...
    <c:choose>
        <c:when test="${!empty promotionExpansion.promotion.prmOgTitle and !empty promotionExpansion.promotion.prmOgImage}">
            <meta property="og:title" content="카카오프렌즈 - ${promotionExpansion.promotion.prmOgTitle}">
...
<div id="kakaoWrap">
	...
	<hr class="hide">
	<div id="kakaoContent" class="cont_promotion <c:if test="${kakaoWebView > 0}">kakaotalk</c:if> " role="main">
		<div id="cMain">
