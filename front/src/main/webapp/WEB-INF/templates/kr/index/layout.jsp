...
<body id="indexBody" class="${empty mainTopMap ? '' : 'global_bnr'}">
...
<div id="kakaoWrap">
	...
	<hr class="hide">
	<div id="kakaoContent" class="cont_main <c:if test="${kakaoWebView > 0}">kakaotalk</c:if> " role="main">
...
<script>var cartSuccessText = '장바구니에 담겼습니다.';</script>
<div class="toast"></div>
...
<script>
  ...
  promotionText = 'test';
  promotionText = '<a href="/kr/promotions/promotion/204"><img src="http://t1.kakaocdn.net/friends/new_store/banner_nomember.png" alt="지금 멤버십 가입하면 1000P 즉시 지급!"></a>';
  </sec:authorize>
  <sec:authorize access="isAuthenticated()">
  promotionText = 'aaa';
  promotionText = '<a href="/kr/promotions/promotion/204"><img src="http://t1.kakaocdn.net/friends/new_store/banner_member.png" alt="지금 프렌즈 상품 구매하고 포인트 2배 6% 적립받자!"></a>';
  </sec:authorize>
</script>
</body>
