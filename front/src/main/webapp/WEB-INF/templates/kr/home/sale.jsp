...
<div class="section_sale">
               ...
               onclick="mainAreaCounting(this.href, 'saleProduct'+'${status.index}')">
                ...
                <div class="sale_info">
                    ...
                    <p class="item_state">
                        ...
                        <a href="${cartPath}/5020/FRPBRYTMS1014"
            ...
            <a href="/kr/products/5070"
               onclick="mainAreaCounting(this.href, 'saleProduct'+'${status.index}')">
                ...
                <div class="sale_info">
                    ...
                    <p class="item_state">
                        <c:if test="${!empty bestProduct.product.defaultPrcode}">
                        <a href="${cartPath}/5070/FRPBAPWSP0001"
                           class="link_cart link_cart_img ${(bestProduct.basketCheck > 0) ? 'on link_cart_on_img' : ''}">
                                <%--<!-- 대표상품 설정되있을때 -->--%>
                            </c:if>
                            <c:if test="${empty bestProduct.product.defaultPrcode}">
            ...
            <a href="/kr/products/5058"
               onclick="mainAreaCounting(this.href, 'saleProduct'+'${status.index}')">
                ...
                <div class="sale_info">
                    ...
                    <p class="item_state">
                        <c:if test="${!empty bestProduct.product.defaultPrcode}">
                        <a href="${cartPath}/5058/FRPBFRMFC0001"
                           class="link_cart link_cart_img ${(bestProduct.basketCheck > 0) ? 'on link_cart_on_img' : ''}">
                                <%--<!-- 대표상품 설정되있을때 -->--%>
                            </c:if>
                            <c:if test="${empty bestProduct.product.defaultPrcode}">
            ...
            <a href="/kr/products/5073"
               onclick="mainAreaCounting(this.href, 'saleProduct'+'${status.index}')">
                ...
                <div class="sale_info">
                    ...
                    <p class="item_state">
                        <c:if test="${!empty bestProduct.product.defaultPrcode}">
                        <a href="${cartPath}/5073/FRPBMZSQT0003"
                           class="link_cart link_cart_img ${(bestProduct.basketCheck > 0) ? 'on link_cart_on_img' : ''}">
                                <%--<!-- 대표상품 설정되있을때 -->--%>
                            </c:if>
                            <c:if test="${empty bestProduct.product.defaultPrcode}">
            ...
            <a href="/kr/products/4532"
               onclick="mainAreaCounting(this.href, 'saleProduct'+'${status.index}')">
                ...
                <div class="sale_info">
                    ...
                    <p class="item_state">
                        <c:if test="${!empty bestProduct.product.defaultPrcode}">
                        <a href="${cartPath}4532/FRPBNEHPP0004"
                           class="link_cart link_cart_img ${(bestProduct.basketCheck > 0) ? 'on link_cart_on_img' : ''}">
                                <%--<!-- 대표상품 설정되있을때 -->--%>
                            </c:if>
                            <c:if test="${empty bestProduct.product.defaultPrcode}">
                            <a href="/kr/products/4532햐"
                               class="link_cart link_cart_img ${(bestProduct.basketCheck > 0) ? 'on link_cart_on_img' : ''}">
                                <!-- 대표상품 설정 안되있을때 -->
                                </c:if>
                                <span class="screen_out">장바구니</span>
    ...
    <ul class="list_goods">
        ...
        <%--<c:forEach items="${bestProducts}" var="newSaleProducts" varStatus="status">--%>
            <li>
                <a href="/kr/products/${newSaleProducts.product.prCode}"
                   onclick="mainAreaCounting(this.href, 'bestProduct'+'${status.index}')">
                    ...
                    <strong class="tit_item">${newSaleProducts.product.prName}</strong>
                    <c:choose>
                        <c:when test="${!newSaleProducts.isDiscountPeriod}">
                            <p class="txt_price">
                        ...
                        <c:otherwise>
                            <p class="txt_price">
                                ...
                                <span>
                                    <fmt:formatNumber
                                            value="${newSaleProducts.productLevelPrice.prlpDiscountprice1}"
                                            type="number"/>원
