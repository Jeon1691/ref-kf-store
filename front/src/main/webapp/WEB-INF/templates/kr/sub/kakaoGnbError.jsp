...
<div class="inner_head">
    ...
    <c:if test="${isKakaoNotMain && !isSignup}">
        <a href="javascript:back()" class="link_back"><span class="ico_kakaotalk_header_back ico_back" style="font-size:1px;"></span></a>
    </c:if>
    <a href="#none" class="link_navi <c:if test="${isKakaoNotMain}">kakaotalk</c:if>" style="display: none;">
    ...
    <div class="wrap_util"><!-- 마이메뉴 오버 시 mypage_on 클래스 추가 -->
        <button type="button" class="btn_search <c:if test="${kakaoWebView > 0}">kakaotalk</c:if>" <c:if test="${isSignup}">style="display: none;"</c:if> <c:if test="${kakaoWebView == 1}">style="right: 10px;"</c:if>>
            <c:if test="${kakaoWebView == 0}">
            <span class="img_gnb ico_search">상품검색하기</span>
            </c:if>
            <c:if test="${kakaoWebView > 0}">
                <span class="ico_kakaotalk_header_search ico_search">상품검색하기</span>
            </c:if>
        ...
        <sec:authorize access="isAnonymous()">
            <a href="/kr/signin" class="link_mypage"><span class="img_gnb ico_mypage">마이페이지</span></a><!-- 클릭 시 .wrap_util에 mypage_on 클래스 추가 -->
        </sec:authorize>
        <sec:authorize access="isAuthenticated()">
            <a href="/kr/mypage/orderlist" class="link_mypage"><span class="img_gnb ico_mypage">마이페이지</span></a><!-- 클릭 시 .wrap_util에 mypage_on 클래스 추가 -->
        </sec:authorize>
        <div id="layerMyPage" class="layer_mypage">
            ...
            <sec:authorize access="isAnonymous()">
                ...
                <ul class="list_mymenu">
                    <li><a href="/kr/signin" class="link_item link_login">로그인</a></li>
                    <li><a href="javascript:loginPopup();" class="link_item link_disalbed">주문내역</a></li>
                    <li><a href="javascript:loginPopup();" class="link_item link_disalbed">찜</a></li>
                    <li><a href="javascript:loginPopup();" class="link_item link_disalbed">취소 및 교환</a></li>
                    <li><a href="javascript:loginPopup();" class="link_item link_disalbed">포인트</a></li>
                    <li><a href="javascript:loginPopup();" class="link_item link_disalbed">쿠폰</a></li>
                    <li><a href="javascript:loginPopup();" class="link_item link_disalbed">1:1 문의</a></li>
