...
<head>
	<tiles:insertTemplate template="/WEB-INF/templates/kr/ohmyfriends/layoutHeader.jsp" flush="true"/>
</head>
<body>
<div id="kakaoIndex">
...
<div id="kakaoWrap">
	...
	<div class="scroll_body">
		<div id="kakaoContent" class="cont_omf <c:if test="${kakaoWebView > 0}">kakaotalk</c:if> " role="main">
			<div id="cMain">
