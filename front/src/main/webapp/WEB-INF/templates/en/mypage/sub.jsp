...
<div id="mSub">
	<div class="visual_intro mypage_intro" style="background-color:#ffdc00"><!-- 인라인스타일로 배경컬러값 변경 -->
		<div class="inner_intro">
			<h2 id="kakaoBody" class="screen_out">my page</h2>
			<h3 class="screen_out">My information</h3>
			<div class="profile_user">
				<strong class="tit_username">Hello,</br> <span class="txt_name">${!empty myInfoTop.myInfo.name ? myInfoTop.myInfo.name : 'Customer'}</span></strong>
				<dl class="info_account">
					<dt class="screen_out">Account </dt>
					<dd>
			...
			<div class="membership_point">
				<div class="point_section">
                    ...
                    <p class="txt_point gotopoint_kr">
						<span class="txt_point_numbers">7,300,000</span>
...
<c:if test = "${!fn:startsWith(myInfo.barcode, 'BARCODE') && myInfo.barcode != null}">
	...
	<div class="box_useinfo">
		...
		<dl class="info_mypoint">
			<dt class="tit_info">Earn Points</dt>
			...
			<dt class="screen_out">Available Points </dt>
            <dd><em class="num_point"><fmt:formatNumber value="${myInfoTop.myPageTopData.MYPOINTREST >= 0 ? myInfoTop.myPageTopData.MYPOINTREST : 0}" type="number"/></em> points are available to use</dd>
        <%--<dd><em class="num_point"><fmt:formatNumber value="${myInfoTop.myPageTopData.MYPOINTREST >= 3000 ? myInfoTop.myPageTopData.MYPOINTREST : 0}" type="number"/></em> points are available to use</dd>--%>
		</dl>
