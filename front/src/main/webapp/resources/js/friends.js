...
var fr = (function(){
    ...
    gnbMenu = function(){
        // pc gnb
        var target = $("#kakaoGnb .gnb_newfriends");
        ...
        $("#kakaoGnb .gnb_newfriends").on("mouseleave",function(){
