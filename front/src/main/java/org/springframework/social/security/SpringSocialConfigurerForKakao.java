 ...
 * @author Craig Walls
 */
public class SpringSocialConfigurerForKakao extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {
	 ...
	 */
	public SpringSocialConfigurerForKakao() {
	}
	...
	public void configure(HttpSecurity http) throws Exception {		
		...
		SocialAuthenticationFilterForKakao filter = new SocialAuthenticationFilterForKakao(
				http.getSharedObject(AuthenticationManager.class), 
				userIdSource != null ? userIdSource : new AuthenticationNameUserIdSource(), 
				usersConnectionRepository, 
				authServiceLocator);

		filter.setAuthenticationSuccessHandler( new SocialAuthenticationTargetUrlRequestHandlerForKakao() );
	 ...
	 */
	public SpringSocialConfigurerForKakao userIdSource( UserIdSource userIdSource) {
     ...
     * @return this SpringSocialConfigurer for chained configuration
	 */
	public SpringSocialConfigurerForKakao postLoginUrl( String postLoginUrl) {
     ...
     * @return this SpringSocialConfigurer for chained configuration
	 */
	public SpringSocialConfigurerForKakao alwaysUsePostLoginUrl( boolean alwaysUsePostLoginUrl) {
     ...
     * @return this SpringSocialConfigurer for chained configuration
	 */
	public SpringSocialConfigurerForKakao postFailureUrl( String postFailureUrl) {
	 ...
	 * @return this SpringSocialConfigurer for chained configuration
	 */
	public SpringSocialConfigurerForKakao signupUrl( String signupUrl) {
	 ...
	 * @return this SpringSocialConfigurer for chained configuration
	 */
	public SpringSocialConfigurerForKakao connectionAddedRedirectUrl( String connectionAddedRedirectUrl) {
	 ...
	 * @return this SpringSocialConfigurer for chained configuration
	 */
	public SpringSocialConfigurerForKakao defaultFailureUrl( String defaultFailureUrl) {
